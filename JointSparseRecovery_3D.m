...
function JointSparseRecovery_3D(im_final,xImage,yImage,f1,azimuthVals,elev1,idxImage)
...
D_z = 80; % height of scene [-60m,60m]
...
X2=  spg_group(A1,phTotal,groups, sigma_n, options );
clear groups;
